...
def test_selection_error_for_missing_artifact() -> None:
    ...
    error = _assert_selection_error(store, missing_ref, "artifact_missing")
...
def test_selection_error_for_incomplete_artifact() -> None:
    ...
    error = _assert_selection_error(store, ref, "artifact_incomplete")
...
def test_selection_error_for_missing_table() -> None:
    ...
    error = _assert_selection_error(store, ref, "selection_table_missing")
...
def test_selection_error_for_missing_column() -> None:
    ...
    error = _assert_selection_error(store, ref, "selection_column_missing")
...
def test_selection_error_for_missing_row_ids() -> None:
    ...
    error = _assert_selection_error(store, ref, "selection_row_ids_missing")
...
def test_selection_error_for_missing_artifact_values() -> None:
    ...
    error = _assert_selection_error(store, ref, "selection_values_missing")
...
def test_selection_error_for_changed_row_identity() -> None:
    ...
    error = _assert_selection_error(store, ref, "row_identity_mismatch")
...
def test_selection_error_for_changed_values() -> None:
    ...
    error = _assert_selection_error(store, ref, "selection_values_changed")

    assert "no longer matches" in str(error)


def test_artifact_selection_error_has_public_facades() -> None:
    assert scarf.ArtifactSelectionError is ArtifactSelectionError
    assert scarf.graph.ArtifactSelectionError is ArtifactSelectionError


def test_artifact_selection_error_round_trips_through_pickle() -> None:
    error = ArtifactSelectionError(
    ...
    assert type(restored) is ArtifactSelectionError
