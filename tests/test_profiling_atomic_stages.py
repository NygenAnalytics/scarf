...
def test_atomic_profile_stage_publishes_state_and_preserves_parameters(
    stage: StageName,
    method: str,
...
@pytest.mark.slow
def test_atomic_profile_stages_chain_through_persisted_assay_state(
    ...
    for stage in ATOMIC_GRAPH_STAGE_ORDER:
        result = run_stage(
            stage,
