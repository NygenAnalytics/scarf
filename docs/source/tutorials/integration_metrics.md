...
scarf.cytebase.connect("scarf_docs").download_dataset('kang_15K_pbmc_rnaseq', destination='scarf_datasets', zarr=True)
scarf.cytebase.connect("scarf_docs").download_dataset('kang_14K_ifnb-pbmc_rnaseq', destination='scarf_datasets', zarr=True)
