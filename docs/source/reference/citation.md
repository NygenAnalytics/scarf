...
Development and maintenance are led by [Nygen](https://nygen.io).
[ScarfWeb](https://www.nygen.io/products/scarfweb) is a separate hosted interface that uses Scarf; it is not required to run the library locally.
