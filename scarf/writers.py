...
from .readers import CrReader, H5adReader, LoomReader, CSVReader
...
def finalize_writer_counts(
    ...
    from .storage.zarr_store import write_counts_t
    ...
    if workspace is None:
        ...
        group = as_zarr_group(
            store[f"matrices/{assay_name}"], name=f"matrices/{assay_name}"
        )
